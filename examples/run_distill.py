...
def distill_train(args, model, teacher_model, datasets, all_dataset_sampler, task_id=-1):
...
def main():
    ...
    parser.add_argument("--teacher_model_name_or_path", default=None, type=str, required=True,
                        help="Path to pre-trained model or shortcut name selected in the list: " + ", ".join(
                            ALL_MODELS))
    parser.add_argument("--teacher_config_name", default="", type=str, required=True,
    ...
    if args.do_train:
        ...
        model = distill_train(args, model, teacher_model, all_train_datasets, all_dataset_sampler=all_dataset_sampler)
